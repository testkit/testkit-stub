...
LOCAL_STATIC_LIBRARIES += $(NDK_PATH)/sources/cxx-stl/gnu-libstdc++/4.6/libs/$(TARGET_ARCH_ABI)/libsupc++.a
LOCAL_STATIC_LIBRARIES += $(NDK_PATH)/sources/cxx-stl/gnu-libstdc++/4.6/libs/$(TARGET_ARCH_ABI)/libgnustl_static.a
